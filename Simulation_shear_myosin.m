...
P.myosin_ini = 10;%number of initial myosin rodsX2
...
% myosin rods nodes
% check wich triangles have 3 actin nodes and 3 spectrin edges after adding
% the myosin
...
P.t_detach = 120;
P.t_end = P.t_detach + 120;%s,end time
